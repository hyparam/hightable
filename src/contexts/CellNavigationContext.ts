...
interface CellNavigationContextType {
  ...
  shouldScrollHorizontally?: boolean // true if the table should scroll horizontally to the current cell
  ...
  setShouldScrollHorizontally?: (shouldScrollHorizontally: boolean) => void // function to set the shouldScrollHorizontally state
