...
import { useViewportWidth } from '../contexts/ViewportContext.js'
 ...
 */
export function ColumnWidthsProvider({ children, localStorageKey, numColumns, minWidth, tableCornerWidth }: ColumnWidthsProviderProps) {
